...
class MyBot(BaseBot):
          ...
          async def on_user_join(self, user: User, position: Position | AnchorPosition):
            await self.highrise.send_whisper(user.id,f" Welcome to FIND A Bebe💗. @{user.username},  Enjoy your stay, find new people and possibly the love of your life. If you need assistance, request a mod in chat.")
